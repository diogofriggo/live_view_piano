defmodule LiveViewPianoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveViewPianoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveViewPianoWeb.Gettext, "errors", msg, opts)
    end
  end
